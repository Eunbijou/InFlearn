...
public class BookServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * 
		 * con = DriverManager.getConnection(url, id, pw); stmt = con.createStatement();
		 * String sql = "SELECT * FROM book"; res = stmt.executeQuery(sql);
		 * 
		 ...
		 * 
		 * } catch (Exception e) { e.printStackTrace(); } finally { try { if(res !=
		 * null) res.close(); if(stmt != null) stmt.close(); if(con != null)
