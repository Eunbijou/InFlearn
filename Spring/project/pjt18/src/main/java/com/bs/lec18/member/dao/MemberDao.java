...
public class MemberDao implements IMemberDao {
	...
	public void memberInsert(String memId, String memPw, String memMail, String memPhone1, String memPhone2,
		...
		/*
		 * member.setMemPhone1(memPhone1); member.setMemPhone2(memPhone2);
		...
		while (iterator.hasNext()) {
			 ...
			 * mem.getMemPhone2() + " - " + mem.getMemPhone3() + "\n");
			 */
			System.out.print("|memberPhone:" + mem.getMemPhone().getMemPhone1() + " - "
					+ mem.getMemPhone().getMemPhone2() + " - " + mem.getMemPhone().getMemPhone3() + "\n");
		}
...
//		System.out.println("memPhone : " + member.getMemPhone1() + " - " + member.getMemPhone2() + " - " + member.getMemPhone3());
		System.out.println("memPhone : " + member.getMemPhone().getMemPhone1() + " - "
				+ member.getMemPhone().getMemPhone2() + " - " + member.getMemPhone().getMemPhone3());
